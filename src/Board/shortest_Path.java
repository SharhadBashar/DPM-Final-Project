...
public class shortest_Path {
	...
	private static String initialT;
	...
	private static Board_Movement orientate;
//Sharhad Bashar
//Micheal Abdallah
	
	// executes navigation to final location
	
	public shortest_Path(int[][] position, int sizeX, int sizeY){
	...
	public static void calculate() {
		...
		Board_Movement determineInitial = new Board_Movement(mapClass);
